...
INSERT INTO `notice` VALUES (1,'Pratik where id = 2'),(2,'Pratik where id = 2'),(3,'Pratik where id = 2'),(4,'Pratik where id = 2'),(5,'Pratik where id = 2'),(6,'Pratik where id = 2'),(7,'Pratik where id = 2'),(8,'Pratik where id = 2'),(9,'Pratik Jain');
...
INSERT INTO `student` VALUES (1,'PRATIK','JAIN',44,1,'Male','MH','PUNE','2019-12-19','pjpratikjin7@gmail,com','10TH','A',1,1,1,'pratik','123'),(2,'PRASAD','DESHMUKH',45,1,'Male','MH','PUNE','2019-12-18','pjprasaddeshmukh17@gmail,com','9TH','A',1,2,2,'prasad','123'),(3,'PRASHANT','JAIN',46,1,'Male','MH','PUNE','2019-12-05','pratikl17@gmail,com','10TH','A',1,2,3,'prashant','123'),(4,'PRATIK','LAVHANE',47,1,'Male','MH','PUNE','2019-11-29','PRATIK@gmail,com','8TH','A',1,3,4,'pratik1','123'),(5,'PRANAV','JOSHI',48,1,'Male','MH','PUNE','2019-12-10','pranav@gmail,com','10TH','A',1,1,5,'pranav','123'),(6,'SHRIPAD','JOSHI',49,1,'Male','MH','PUNE','2019-12-12','SHRIPAD@gmail,com','10TH','A',1,1,6,'shripad','123'),(7,'AKASH','PATIL',50,1,'Male','MH','PUNE','2019-12-07','chaitali@gmail,com','10TH','A',1,1,7,'akash','123'),(8,'CHAITALI','POTODE',51,1,'Female','MH','PUNE','2019-12-23','CHAI@gmail,com','8TH','A',1,3,8,'chaitali','123'),(18,'Shaurya','Jain',55,1,'Male','MH','Buldhana','2019-12-12','pjshaurya@gmail.com','10TH','A',1,1,19,'shaurya','123');
...
-- Dump completed on 2019-12-28 23:53:51
